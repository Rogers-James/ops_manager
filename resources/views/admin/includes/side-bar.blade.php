...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('admin.reports.employee') ? 'active' : '' }}">
                    <a href="{{ route('admin.reports.employee') }}" class="menu-link">
                        <div>Employee Reports</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->routeIs('admin.reports.attendance') ? 'active' : '' }}">
                    <a href="{{ route('admin.reports.attendance') }}" class="menu-link">
                        <div>Attendance Reports</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->routeIs('admin.reports.leave') ? 'active' : '' }}">
                    <a href="{{ route('admin.reports.leave') }}" class="menu-link">
                        <div>Leave Reports</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->routeIs('admin.reports.payroll') ? 'active' : '' }}">
                    <a href="{{ route('admin.reports.payroll') }}" class="menu-link">
                        <div>Payroll Reports</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->routeIs('admin.reports.audit_logs') ? 'active' : '' }}">
                    <a href="{{ route('admin.reports.audit_logs') }}" class="menu-link">
                        <div>Audit Logs</div>
                    </a>
                </li>
            </ul>
        ...
        <li
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('admin.settings.custom_fields') ? 'active' : '' }}">
                    <a href="{{ route('admin.settings.custom_fields') }}" class="menu-link">
